...
Sarah a rédigé un blogue sur son approche de ces données, qui comprend le nettoyage des données et une application Shiny .
Elle a découvert les audits de marque de "Break Free From Plastic" en s'impliquant dans la "Social Justice Cooperative of Newfoundland" and "Labrador's Zero Waste Action Team".
Elle a téléchargé les données brutes de son Google Drive, et a pu rédiger un court script de nettoyage et de jointure des données.
...
-En quelle année, y'a t'il eu le plus de volontaires / évènements ?
...
Cette question nous fait réalisée que la variable "Source_plastic"  ne peut être d'une grande utilité dans le traitement de nos données au regard de son unicité.
La sous-table créée servira à repondre à des questions comme "le nombre de source de plastique d'un pays ".

...
```{r}
### african_names[african_names==0] <- NA ## permet de tranformer les 0 en NA, dans le code en dessous je ne prends pas les NA. ATTENTION RECTIFICATION, DEJA FAIT EN BAS DONC NE SERT A RIEN ICI ! Je garde le code pour plus tard, à titre de "cours" ou "note". 

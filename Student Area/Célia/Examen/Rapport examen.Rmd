...
```
![](C:/Users/Brig/Documents/Célia/R/Intro-to-R-M1-C2ES-2021/Student Area/Célia/Examen/Energie-Renouvelable.jpg) 
--> à changer, aller chercher la photo directement sur internet
...
energy_types %>% 
  ...
  mutate(type2 = case_when(
    ...
    type == "Hydro" ~ "Hydro",
    type == "Pumped hydro power" ~ "Pumped hydro",
    type == "Wind" ~ "Wind",
    type == "Solar" ~ "Solar",
  ...
  geom_bar()+
  scale_fill_brewer(palette = "à remplir", direction = -1)
```
...
```{r}
cc <- tidy(cor.test(qu8$`Total net production`, qu8$pourcent_ren))
```

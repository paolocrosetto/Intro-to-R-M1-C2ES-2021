...
On ne voit pas clairement de tendance se dégager mais il y a peut-être une corrélation positive. On peut calculer la corrélation entre les deux variables :

```{r}
cor(qu8$Imports, qu8$pourcent_ren)
```
...
La p.value est faible, il y a une corrélation entre le pourcentage de la demande satisfaite grâce aux importations et le pourcentage d'énergie renouvelable. 

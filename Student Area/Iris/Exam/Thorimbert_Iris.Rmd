...
#### **Combien d'individus ont partagé un prix à plusieurs?**
...
```
Ce tableau nous montre combien de personnes ont partagé leur prix et avec combien d'invidus. Ainsi on constate que la majorité des prix ont été gagné seul. Environ 1 femme sur 2 a gagné son prix en étant seule tandis que pour les hommes, ils ne sont que 35%.
...
multiple <-  filter(multiple$N > 1)

as.numeric(multiple$N)
```
...
Ces résultats ne sont pas surprenants. Comme nous l'avons vu juste avant, les Etats-Unis sont le pays le plus récompensé, suivi ensuite du Royaume-Uni. C'est donc sans surprise que ces deux pays arrivent en tête dans quasisement toutes catégories. On peut tout de même constater que le prix Nobel de littérature n'est pas gagné en majorité par les Etats-Unis mais par la France avec 11 gagnants, suivit de près par leur concurrent américain avec 9.
